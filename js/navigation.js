        ...
        function abertura() {
            ...
            if (local == "ambiente dos professores ii" || local == "ambiente 58 - ambiente 71" || local == "ambiente 58" || local == "ambiente 59" || local == "ambiente 60" || local == "ambiente 61" || local == "ambiente 62" || local == "ambiente 63" || local == "ambiente 64" || local == "ambiente 65" || local == "ambiente 66" || local == "ambiente 67" || local == "ambiente 68" || local == "ambiente 69" || local == "ambiente 70" || local == "ambiente 71") {
                ...
                L.marker([-7.139162744817215, -34.85106289386749], {
                    icon: transmarker
                }).addTo(map).bindPopup(Ambiente2_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.139037658321243, -34.85082685947418], {
                    icon: transmarker
                }).addTo(map).bindPopup(BlocoV_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.139338398136814, -34.850730299949646], {
                    icon: transmarker
                }).addTo(map).bindPopup(Praca_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.139732287153718, -34.85062301158905], {
                    icon: transmarker
                }).addTo(map).bindPopup(BlocoIV_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.139253232899373, -34.850904643535614], {
                    icon: transmarker
                }).addTo(map).bindPopup(BlocoPsico_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.139325091069513, -34.850998520851135], {
                    icon: transmarker
                }).addTo(map).bindPopup(BlocoC_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.1397589012642495, -34.85075980424881], {
                    icon: transmarker
                }).addTo(map).bindPopup(Auditorios_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.139923908714983, -34.85083222389221], {
                    icon: transmarker
                }).addTo(map).bindPopup(BlocoA_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.136307038206137, -34.84924435615539], {
                    icon: transmarker
                }).addTo(map).bindPopup(DEMID_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.139788176784048, -34.85136866569519], {
                    icon: transmarker
                }).addTo(map).bindPopup(BibliotecaSetorial_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.139673736105113, -34.85096096992493], {
                    icon: transmarker
                }).addTo(map).bindPopup(ClinicaPsicologia_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.139074918132136, -34.85094487667084], {
                    icon: transmarker
                }).addTo(map).bindPopup(CAs_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
                ...
                L.marker([-7.139923908714983, -34.85083222389221], {
                    icon: transmarker
                }).addTo(map).bindPopup(notFound_pop).on('popupopen', function() { mudarUrl(); }).openPopup();
            }
        };
